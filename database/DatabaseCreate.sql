...
CREATE TABLE IF NOT EXISTS `mydb`.`Customer` (
  ...
  `lastUpdate` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ContactData_contactDataId` INT NOT NULL,
  PRIMARY KEY (`customerID`),
  UNIQUE INDEX `custId_UNIQUE` (`customerID` ASC),
  INDEX `fk_Customer_ContactData1_idx` (`ContactData_contactDataId` ASC),
  CONSTRAINT `fk_Customer_ContactData1`
    FOREIGN KEY (`ContactData_contactDataId`)
