...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`conference_room` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `room_no` INT(11) NOT NULL,
  `conference_room_id` INT(11) NOT NULL AUTO_INCREMENT,
  INDEX `fk_conference_room_room1_idx` (`room_no` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`hotel_room` (
  ...
  INDEX `fk_hotel_room_room1_idx` (`room_no` ASC) VISIBLE,
