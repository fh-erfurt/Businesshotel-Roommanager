...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`conference_room` (
  ...
  UNIQUE INDEX `conference_room_id_UNIQUE` (`conference_room_id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`hotel_room` (
  ...
  UNIQUE INDEX `hotel_room_id_UNIQUE` (`hotel_room_id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`room` (
  ...
  INDEX `fk_room_hotel_room1_idx` (`hotel_room_id` ASC),
  INDEX `fk_room_conference_room1_idx` (`conference_room_id` ASC),
  UNIQUE INDEX `conference_room_conference_room_id_UNIQUE` (`conference_room_id` ASC),
  UNIQUE INDEX `hotel_room_hotel_room_id_UNIQUE` (`hotel_room_id` ASC),
...
CREATE TABLE IF NOT EXISTS `bh_room_db`.`booking_request` (
  ...
  UNIQUE INDEX `booking_no_unique` (`booking_request_id` ASC),
  INDEX `fk_booking_customer1_idx` (`customer_id` ASC),
